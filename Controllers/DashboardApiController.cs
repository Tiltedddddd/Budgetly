...
namespace Budgetly.Controllers
{
    ...
    {
        // Updated to match the name in your Web.config
        private readonly string _conn =
            ConfigurationManager.ConnectionStrings["BudgetlyDB"].ConnectionString;

        [HttpGet]
        [Route("api/accounts/{userId}")] // Route now requires userId
